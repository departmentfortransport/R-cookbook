...
- Rproj is the file extension for an R project, essentially a working directory marker
...
Why you should work in an R project, how to set up and project happiness...
